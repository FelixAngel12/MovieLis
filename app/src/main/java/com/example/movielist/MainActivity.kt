...
class MainActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMainBinding
        ...
        Movies(
            ...
            "Fecha de Publicación: sale el 4 de marzo de 2022 "
        ),
        Movies(
        ...
        Movies(
            ...
            "Fecha de Publicación: sale 11 de marzo de 2022 "
        ),
        Movies(
            "Virus:32",
        ...
        Movies(
            ...
            "Fecha de Publicación: 25 de noviembre  2021 "
        )
    )
    ...
    fun onItemSelected(movies: Movies) {
        ...
        intent.putExtra("Fecha",movies.Fecha)
